...
|------|---------|---------|
| Local fact path | Fact in this knowledge base | `kb/technology/debugging/pool-fix.md` |
| Repo-qualified | Fact in another repo mounted in this [lens](/docs/lenses/), addressed by 12-hex repo id | `kb://a1b2c3d4e5f6/kb/technology/debugging/pool-fix.md` |
| Source anchor | Source file, pinned to a commit **and a blob** | `src://7b4887ce51d9/internal/store/service.go@<40-hex commit>:<40-hex blob>` |
...
alike. Eight tools cover the full fact lifecycle — their descriptions carry all
